...
const BottomNav = () => {
	...
	return (
		<div className='sm:hidden navtabs'>
			<nav className='fixed bottom-0 w-full border-t navtabs'>
				<div className='mx-auto flex h-16 max-w-md items-center space-between' style={{height: '5.5rem', marginTop: '-10px'}}>
