...
const video3 = '366c08b5d84e67f8bfb546879e2afc40'
...
const stories = [
	...
	},
	{
		content: ({ action, isPaused }) => {
			return (
				<div className='contentStyle'>
					<Stream controls={false} src={video2} autoplay={true} loop={true} volume={1} />
				</div>
			)
		},
	},
	{
		content: ({ action, isPaused }) => {
			return (
				<div className='contentStyle'>
					<Stream controls={false} src={video3} autoplay={true} loop={true} volume={1} />
				</div>
			)
		},
	},
